...
START = 'START 2 PLAYERS'
RULES = 'RULES'
OPTIONS = 'OPTIONS'
NEWGAME = 'NEW GAME'
QUIT = 'QUIT'
RANDOM_START = 'START WITH COMPUTER'
...
def start_menu(screen, state, event):
    ...
    button_width = WIDTH / 1.5
    button_height = HEIGHT / 10
    button_pos = WIDTH / 2 - button_width / 2

    rect1 = pg.Rect(button_pos, 4 / 9 * HEIGHT, button_width,
                    button_height)
    rect2 = pg.Rect(button_pos, 3 / 9 * HEIGHT, button_width,
                    button_height)
    rect3 = pg.Rect(button_pos, 5 / 9 * HEIGHT, button_width,
                    button_height)

    buttons = [StartButton(START, rect1), StartButton(RANDOM_START, rect3), StartButton(RULES, rect2)]
